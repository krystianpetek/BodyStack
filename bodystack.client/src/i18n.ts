...
const resources = {
  en: {
    translation: {
      ...
      suunto: {
        ...
        activity: 'Activity',
        total: 'Total',
        pleaseLogin: 'Please authenticate with Suunto to view workouts',
        date: 'Date',
      },
    },
  },
  pl: {
    translation: {
      ...
      suunto: {
        workouts: 'Treningi',
        noWorkouts: 'Nie znaleziono treningów',
        workoutsCount: 'treningów',
        ...
        maxHr: 'Max',
        zones: 'Strefy HR',
        dailySummary: 'Podsumowanie energetyczne',
        bmr: 'BMR (Podstawowa)',
        activity: 'Aktywność',
        total: 'Suma',
        pleaseLogin: 'Zaloguj się do Suunto, aby zobaczyć treningi',
        date: 'Data',
      },
    },
  },
